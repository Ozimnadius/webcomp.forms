 ...
 * события и шаблона. Перед удалением инфоблока удаляет связанные почтовые
...
class IblockHandler
{
    ...
    /**
     * Обработчик события перед удалением инфоблока.
     *
     * @param int $iblockId ID удаляемого инфоблока.
     *
     * @return void
     */
    public static function onBeforeIBlockDelete(int $iblockId): void
    {
